...
public class TTransactionParam implements org.apache.thrift.TBase<TTransactionParam, TTransactionParam._Fields>, java.io.Serializable, Cloneable, Comparable<TTransactionParam> {
  ...
  private static final org.apache.thrift.protocol.TField SLIPPAGE_FIELD_DESC = new org.apache.thrift.protocol.TField("slippage", org.apache.thrift.protocol.TType.DOUBLE, (short)2);
  private static final org.apache.thrift.protocol.TField COMMISSION_FIELD_DESC = new org.apache.thrift.protocol.TField("commission", org.apache.thrift.protocol.TType.DOUBLE, (short)3);
  private static final org.apache.thrift.protocol.TField TAX_PERCENT_FIELD_DESC = new org.apache.thrift.protocol.TField("taxPercent", org.apache.thrift.protocol.TType.DOUBLE, (short)4);
  ...
  public double slippage; // optional
  public double commission; // optional
  public double taxPercent; // optional
  ...
  private static final int __SLIPPAGE_ISSET_ID = 0;
  private static final int __COMMISSION_ISSET_ID = 1;
  private static final int __TAXPERCENT_ISSET_ID = 2;
  ...
  public TTransactionParam setSlippage(double slippage) {
    this.slippage = slippage;
    setSlippageIsSet(true);
    return this;
  }

  public void unsetSlippage() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __SLIPPAGE_ISSET_ID);
  }

  /** Returns true if field slippage is set (has been assigned a value) and false otherwise */
  public boolean isSetSlippage() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __SLIPPAGE_ISSET_ID);
  }

  public void setSlippageIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __SLIPPAGE_ISSET_ID, value);
  }
  ...
  public TTransactionParam setCommission(double commission) {
  ...
  public TTransactionParam setTaxPercent(double taxPercent) {
    this.taxPercent = taxPercent;
    setTaxPercentIsSet(true);
    return this;
  }

  public void unsetTaxPercent() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __TAXPERCENT_ISSET_ID);
  }

  /** Returns true if field taxPercent is set (has been assigned a value) and false otherwise */
  public boolean isSetTaxPercent() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __TAXPERCENT_ISSET_ID);
  }

  public void setTaxPercentIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __TAXPERCENT_ISSET_ID, value);
  }
  ...
  public boolean equals(TTransactionParam that) {
    ...
    if (this_present_slippage || that_present_slippage) {
      if (!(this_present_slippage && that_present_slippage))
        return false;
      if (this.slippage != that.slippage)
        return false;
    }
    ...
    if (this_present_taxPercent || that_present_taxPercent) {
      if (!(this_present_taxPercent && that_present_taxPercent))
        return false;
      if (this.taxPercent != that.taxPercent)
        return false;
    }
  ...
  public int hashCode() {
    ...
    if (isSetSlippage())
      hashCode = hashCode * 8191 + org.apache.thrift.TBaseHelper.hashCode(slippage);
    ...
    if (isSetTaxPercent())
      hashCode = hashCode * 8191 + org.apache.thrift.TBaseHelper.hashCode(taxPercent);
  ...
  private static class TTransactionParamStandardScheme extends org.apache.thrift.scheme.StandardScheme<TTransactionParam> {
        ...
        switch (schemeField.id) {
          ...
          case 2: // SLIPPAGE
            if (schemeField.type == org.apache.thrift.protocol.TType.DOUBLE) {
              struct.slippage = iprot.readDouble();
          ...
          case 4: // TAX_PERCENT
            if (schemeField.type == org.apache.thrift.protocol.TType.DOUBLE) {
              struct.taxPercent = iprot.readDouble();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TTransactionParam struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetSlippage()) {
        ...
        oprot.writeDouble(struct.slippage);
        oprot.writeFieldEnd();
      }
      ...
      if (struct.isSetTaxPercent()) {
        ...
        oprot.writeDouble(struct.taxPercent);
        oprot.writeFieldEnd();
      }
